...
/***/ function(module, exports, __webpack_require__) {
	...
	var Details = function (_React$Component) {
	  ...
	  function Details(props) {
	    ...
	    _this.state = {
	      show: _this.props.shows.find(function (show) {
	        return show.imdbID === _this.props.params.id;
	      }),
	      omdbData: {}
	    };
	    return _this;
	  ...
	  _createClass(Details, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      axios.get('http://www.omdbapi.com/?i=' + this.state.show.imdbID).then(function (response) {
	    ...
	    value: function render() {
	      var _state$show = this.state.show;
	      var description = _state$show.description;
	      var poster = _state$show.poster;
	      var title = _state$show.title;
	      var trailer = _state$show.trailer;
	      var year = _state$show.year;
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement('img', { src: '/public/img/posters/' + poster, alt: title, className: 'video-poster' }),
	          React.createElement(
	            'p',
